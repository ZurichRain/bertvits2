import sys
sys.path.append('/data/hypertext/sharpwang/TTS/BaseCode/utils')
sys.path.append('/data/hypertext/sharpwang/TTS/BaseCode/model')
sys.path.append('/data/hypertext/sharpwang/TTS/BaseCode/preprocess')
import copy
import math
import torch
